            ...
            <div className="w-full px-4 md:w-1/2">
              <div className="lg:pl-20">
                <div className="mb-6 ">
                  ...
                  <p class="inline-block text-2xl font-medium text-gray-700 ">
                    
                    <span
                      class="text-base font-normal text-gray-500 line-through ">150.000</span>
                      <span className="text-red-500 ">  đ100.000</span>
                  </p>
                </div>
                ...
                <div class="flex items-center mb-8">
                  <h2 class="w-30 mr-7 text-lg font-bold dark:text-gray-400 opacity-80">
                   Màu sắc:</h2>
                ...
                <div class="flex items-center mb-8">
                  <h2 class="w-34 text-lg font-bold dark:text-gray-400 opacity-80">
                    Chọn size:</h2>
                  <div class="flex flex-wrap mx-2 -mb-2">
                    <button
                ...
                <div className="w-32 mb-8 flex items-center">
  <label htmlFor className="w-full text-xl font-semibold text-gray-700 pr-4">Quantity</label>
  <div className="relative flex flex-row w-full h-10  bg-transparent rounded-lg">
    <button className="w-20 h-full text-gray-600 bg-gray-300 rounded-l outline-none cursor-pointer  hover:bg-gray-400">
    ...
    <button className="w-20 h-full text-gray-600 bg-gray-300 rounded-r outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 dark:bg-gray-900 hover:text-gray-700 hover:bg-gray-400">
      <span className="m-auto text-2xl font-thin">+</span>
                ...
                <div className="flex gap-4 mb-6">
                  <a href="#" className="w-full px-4 py-3 text-center bg-indigo-700 text-gray-100 border border-indigo-300 rounded-full hover:opacity-[0.9]  rounded-xl">
                    Mua Ngay</a>
                </div>
              </div>
            </div>
